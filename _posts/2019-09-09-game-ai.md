...
[^1]: For Citation Purposes - @article{abiaryan, author = "Abi Aryan", title = "Developing AI using Games", year = "2019" }
[^2]: Acknowledgements: I would like to thank Ian Danforth for proofreading the article and providing useful feedback.